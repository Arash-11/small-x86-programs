...
lineDone:
            mov     byte [rdx], 10  ; write a newline char
            ...
            cmp     r8, maxlines    ; did we already finish the last line?
...
maxlines    equ     8
dataSize    equ     44
output:     resb    dataSize        ; reserve 8 bytes of space (without initializing) in memory
